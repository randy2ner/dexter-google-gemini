...
| OneDrive folder transport established | satisfied for one isolated six-file baseline through the native picker | Experiment [ODT-002](../experiments/onedrive-transport/odt-002-native-picker-hierarchy-and-readability.md) passed with all six relative paths and bounded readability probes; experiment [ODT-001](../experiments/onedrive-transport/odt-001-isolated-folder-enumeration.md) remains partial historical evidence. Neither invoked or evaluated Graph Governor. |

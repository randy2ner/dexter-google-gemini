# Experiment: Native OneDrive picker hierarchy and readability

## Metadata

- **Experiment ID:** odt-002-native-picker-hierarchy-and-readability
- **Revision:** 1
- **Owner:** User / product owner
- **Capability under test:** Native Cowork and OneDrive transport; no Skill invoked
- **Risk/priority:** high
